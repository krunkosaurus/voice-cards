...
<objective>
Create the React hook and UI components for P2P connection: useWebRTC hook, ConnectionDialog for code exchange, SyncIndicator for status display, and integrate into Header.
...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>
Full connection UI: useWebRTC hook, SyncIndicator, ConnectionDialog, Header integration.
  </what-built>
  <how-to-verify>
